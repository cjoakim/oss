...
def test_typical_use():
    ...
    bool = g.set_pattern('sample-%.txt', 'e')
    assert(bool == True)
    ...
    assert(str(g).startswith('<Gdg directory:tmp/epoch state:{'))
...
def __test_fixture_files():
    return [
        'tmp/epoch/sample-1612735756.txt',
        'tmp/epoch/sample-1612735757.txt',
        'tmp/epoch/sample-1612735758.txt',
        'tmp/epoch/sample-1612735759.txt',
        'tmp/epoch/sample-1612735760.txt'
    ]
